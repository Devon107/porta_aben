...
export const projects : projects_content[] = [
	{
		...
		description:"This website constitutes a landing page with a product catalog for the ACM Prado distributor and a page with information about the company.",
	...
	},
	{
		...
		description:"Informative site on consulting services for the company MF-Consultores.",

...
export const projects: projects_content[] = [
  {
    ...
    description: "Ecommerce para el cuidado del cabello",
  ...
  },
  {
    ...
    description:
      "Este sitio web constituye un landing page con un catálogo de productos para la distribuidora ACM Prado y una página con información acerca de la empresa.",
  ...
  },
  {
    ...
    description:
      "Sitio web informativo para la empresa desarrolladora Vertikal",
  ...
  },
  {
    ...
    description:
      "Sitio informativo sobre servicios de consultoria para la empresa MF-Consultores",
